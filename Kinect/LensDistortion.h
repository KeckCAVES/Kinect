...
class LensDistortion
	...
	Scalar distortScale(const Point& undistorted) const; // Calculates the differential scaling factor of the forward distortion correction formula at the given location
